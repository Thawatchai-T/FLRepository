...
namespace KTBLeasing.FrontLeasing.Mapping.Orcl {
    ...
    public class CreditLimitGuarantorMap : ClassMap<CreditLimitGuarantor>
    {

        public CreditLimitGuarantorMap()
        {
            ...
            Map(x => x.CreditLimitDetailId).Column("CREDIT_LIMIT_DETAIL_ID");
