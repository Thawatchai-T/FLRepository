...
Ext.define('TabUserInformation.view.Popup.UserInfPopup', {
    extend: 'Ext.window.Window',
    alias: 'widget.popupuserinfpopup',

    requires: [
        'TabUserInformation.view.Popup.UserInfPopupViewModel',
        'TabUserInformation.view.Popup.UserInfPopupViewController',
        'Ext.form.field.Text',
        'Ext.button.Button',
        'Ext.form.RadioGroup',
