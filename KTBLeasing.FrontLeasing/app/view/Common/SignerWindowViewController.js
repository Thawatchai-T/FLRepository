/*
 * File: app/view/Window/SignerWindowViewController.js
 *
...
Ext.define('TabUserInformation.view.Common.SignerWindowViewController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.windowsignerwindow',
        ...
        if (form.isValid()) {
            Ext.MessageBox.confirm('Confirm', 'คุณต้องการที่บันทึกหรือเปลื่ยนแปลงข้อมูล?',
                function (cbtn, bool) {
                    if (cbtn == 'yes') {
                        form.submit({
                            url: 'api/signer/dopost',
                            success: function (form, action) {
                                Ext.Msg.alert('Success', "บันทึกข้อมูลเรียบร้อย");
                                Ext.getCmp('pagingtoolbar-signer').moveFirst();
                            },
