/*
 * File: app/view/Tab/VisitCallingTab.js
 *
...
Ext.define('TabUserInformation.view.Tab.VisitCallingTab', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.tabvisitcallingtab',

    requires: [
        'TabUserInformation.view.Tab.VisitCallingTabViewModel',
        'TabUserInformation.view.Tab.VisitCallingTabViewController',
        'Ext.form.field.Date',
        'Ext.grid.Panel',
    ...
    controller: 'tabvisitcallingtab',
    viewModel: {
        type: 'tabvisitcallingtab'
    },
    height: 900,
    width: '100%',
    layout: 'border',
