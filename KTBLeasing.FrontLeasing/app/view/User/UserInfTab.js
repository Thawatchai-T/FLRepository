...
Ext.define('TabUserInformation.view.User.UserInfTab', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.tabuserinftab',

    requires: [
        'TabUserInformation.view.User.UserInfTabViewModel',
        'TabUserInformation.view.User.UserInfTabViewController',
        'Ext.form.field.Text',
