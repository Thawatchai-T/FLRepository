/*
 * File: app/view/Job/Application/Tab/AnnualTaxViewController.js
 *
...
Ext.define('TabUserInformation.view.Job.Application.Tab.AnnualTaxViewController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.jobapplicationtabannualtax',

    onButtonNewClick: function(button, e, eOpts) {
        var store = this.getView().down('grid').getStore();
        var record = Ext.create('model.annualtax');
    ...
    onStoreBeforeLoad: function (store, operation, eOpts) {
        ...
        store.getProxy().extraParams.name = 'AnnualTax';
    }
